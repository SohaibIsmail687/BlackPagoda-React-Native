    ...
    render() {
      ...
      <StatusBar backgroundColor="#2597CB" barStyle="light-content" />
          ...
          <View style={{ flexDirection: "row", justifyContent: 'space-between',alignItems: "center",  }}>
            ...
            <Text style={{ color: 'white', fontSize: 20, fontWeight: 'bold' }}>Book Appointment</Text>
...
<TouchableOpacity onPress={() => Actions.All_Other_Questions()} activeOpacity={0.8}>
<Text style={{ fontSize: 16, color: 'black', marginTop: 20,  }}>• Chronic pain, related to diseases of the central or peripheral nervous system, such as neuropathic pain </Text>
</TouchableOpacity>
...
<Text style={{ fontSize: 16, color: 'black', marginTop: 20,  }}>• Chronic pain, related to cancer  </Text>
</TouchableOpacity>

<View style={{ borderBottomWidth: 1, borderColor: 'lightgray', marginTop: 20 }}></View>
...
<TouchableOpacity onPress={() => Actions.Doctor_By_Category({guest:this.props.guest,category:name})} activeOpacity={0.8}>
<Text style={{ fontSize: 16, color: 'black', marginTop: 20,  }}>• Severe nausea or vomiting from chemotherapy or radiation therapy  </Text>
</TouchableOpacity>
...
<TouchableOpacity onPress={() => Actions.Doctor_By_Category({guest:this.props.guest,category:name})} activeOpacity={0.8}>
<Text style={{ fontSize: 16, color: 'black', marginTop: 20,  }}>• Severe nausea or vomiting from combination therapy against HIV  </Text>
</TouchableOpacity>
...
<TouchableOpacity onPress={() => Actions.Doctor_By_Category({guest:this.props.guest,category:name})} activeOpacity={0.8}>
<Text style={{ fontSize: 16, color: 'black', marginTop: 20,  }}>• Severe nausea or vomiting from combination therapy against hepatitis C  </Text>
</TouchableOpacity>
...
<TouchableOpacity onPress={() => Actions.Doctor_By_Category({guest:this.props.guest,category:name})} activeOpacity={0.8}>
<Text style={{ fontSize: 16, color: 'black', marginTop: 20,  }}>• Spasticity associated with multiple sclerosis or spinal cord lesions   </Text>
</TouchableOpacity>
...
<TouchableOpacity onPress={() => Actions.All_Categories()} activeOpacity={0.8}>
<Text style={{ fontSize: 16, color: 'black', marginTop: 20,  }}>• Appetite stimulation in the palliative care of patients undergoing treatment for cancer or AIDS   </Text>
</TouchableOpacity>
