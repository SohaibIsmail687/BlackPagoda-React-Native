    ...
    return (
      <View style={{flex: 1, backgroundColor: 'white'}}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {/* <TouchableOpacity activeOpacity={0.8} style={{ flexDirection: 'row', marginTop: 20, alignItems: 'center', justifyContent: 'space-between', paddingVertical: 15, borderBottomWidth: 1, borderColor: 'lightgray', width: width / 1.1, alignSelf: 'center', paddingHorizontal: 5 }}>
            <Text style={{ color: 'black', fontSize: 14, fontWeight: '600', }}>Favourite Doctors</Text>
            <Icon name="chevron-right"
              type="Entypo" style={{ color: "gray", fontSize: 22 }} />
          </TouchableOpacity> */}
