...
class update_doctor_profile extends React.Component {
  ...
  update_doctor = (lat, lng) => {
    ...
    console.log('MobileNumberMobileNumberMobileNumber', this.state.id);
    console.log('MobileNumberMobileNumberMobileNumber', name);
    console.log('MobileNumberMobileNumberMobileNumber', email);
    console.log('MobileNumberMobileNumberMobileNumber', password);
    console.log('MobileNumberMobileNumberMobileNumber', mobile_number);
    console.log('MobileNumberMobileNumberMobileNumber', address);
    console.log('MobileNumberMobileNumberMobileNumber', experience);
    console.log('MobileNumberMobileNumberMobileNumber', degree);
    console.log('MobileNumberMobileNumberMobileNumber', lat);
    console.log('MobileNumberMobileNumberMobileNumber', lng);
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          ...
          <ScrollView>
            <View
              ...
              <Text style={{color: 'gray', marginTop: 5}}>Experience</Text>
              ...
              <Text style={{color: 'gray', marginTop: 5}}>Education</Text>
